                ...
                <div class="ml-4 flex items-center md:ml-6">
                    <?php if(isset($_SESSION["user"])): ?>
                        ...
                        <form method="post" action="/session">
                            ...
                            <button type="submit" class="m-4 relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden">
                                Log out
                            </button>
                        </form>
                    <?php endif; ?>
                    ...
                    <?php if(!isset($_SESSION["user"])): ?>
                        <a href="/registration">
                            <button type="button" class="m-4 relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden">
                                Registration
                            </button>
                        </a>
                        <a href="/login">
